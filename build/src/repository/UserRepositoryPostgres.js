...
var UserRepositoryPostgres = /** @class */ (function () {
    ...
    UserRepositoryPostgres.prototype.createUser = function (username, password, permissions) {
        return __awaiter(this, void 0, void 0, function () {
            var result, userJson, user, _i, permissions_1, permission, permissionResult, permissionJson, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.driver.query('BEGIN')];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                    ...
                    case 6:
                        _i++;
                        return [3 /*break*/, 4];
                    case 7: return [4 /*yield*/, this.driver.query('COMMIT')];
                    case 8:
                        _a.sent();
                    ...
                    case 9:
                        ...
                        return [3 /*break*/, 12];
                    case 10: return [4 /*yield*/, this.driver.query('ROLLBACK')];
                    case 11:
                        _a.sent();
                        return [7 /*endfinally*/];
