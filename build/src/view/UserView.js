...
var UserView = /** @class */ (function () {
    function UserView(controller) {
        this.controller = controller;
    }
    UserView.prototype.loginView = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var username, password, ret, jwt, maxAge, option;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log(password);
                        return [4 /*yield*/, this.controller.logIn(username, password)];
                    case 1:
                        ret = _a.sent();
                        if (ret === null) {
    ...
    UserView.prototype.getUserView = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
